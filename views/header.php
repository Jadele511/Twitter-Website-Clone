...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://chanvn.com/11_twitter/styles.css">
  </head>
  <body>
  ...
  <a class="navbar-brand" href="http://chanvn.com/11_twitter/">Twitter</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="form-inline my-2 my-lg-0">
      <?php  if ($_SESSION['id']) { ?>
          ...
          <a class="btn btn-outline-" href="?function=logout">Logout</a>
      <?php } else { ?>
